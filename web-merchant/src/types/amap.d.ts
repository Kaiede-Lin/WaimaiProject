declare namespace AMap {
  ...
  interface DrivingRouteResult {
    routes: Array<{ steps: any[]; distance: number; time: number }>
  }

  class DrivingRoute {
    constructor(opts?: DrivingRouteOptions)
    search(origin: LngLat, destination: LngLat, callback: (status: string, result: DrivingRouteResult) => void): void
    clear(): void
  }
